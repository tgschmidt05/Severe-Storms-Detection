...
function pageLoaded() 
{
	...
	console.log("Reporting label: (" + dynamicContent.Google_AdWords_Tangram_Feed__Canada_feed[0].Reporting_Label + ")");
	console.log("Exit url: (" + dynamicContent.Google_AdWords_Tangram_Feed__Canada_feed[0].Exit_URL.Url + dynamicContent.Google_AdWords_Tangram_Feed__Canada_feed[0].Sub_ID + ")");

    //Load in CSS
    var extCSS = document.createElement("link");
    extCSS.setAttribute("rel", "stylesheet");
    extCSS.setAttribute("type", "text/css");
    extCSS.setAttribute("href", dynamicContent.Google_AdWords_Tangram_Feed__Canada_feed[0].CSS_Name);
    document.head.appendChild(extCSS);

    var script = document.createElement('script');
	script.type = 'text/javascript';
	script.src = dynamicContent.Google_AdWords_Tangram_Feed__Canada_feed[0].JS_Name;    
...
function initApp()
{
	...
	$("#buttonLabel").innerHTML = dynamicContent.Google_AdWords_Tangram_Feed__Canada_feed[0].CTA_Text; // CTA_Text
...
{
	var tempString = "";
	bgEndColor = dynamicContent.Google_AdWords_Tangram_Feed__Canada_feed[0].BG_Color; // BG_Color
	introCopy2Start = parseFloat(dynamicContent.Google_AdWords_Tangram_Feed__Canada_feed[0].Start_Time_Text_2); // Start_Time_Text_2
	wipeStart = parseFloat(dynamicContent.Google_AdWords_Tangram_Feed__Canada_feed[0].Start_Time_Wipe); // Start_Time_Wipe

	parseFontSizes()

	// Grab dynamic copy text & place into array holders
	tempString  = dynamicContent.Google_AdWords_Tangram_Feed__Canada_feed[0].text_1; // Text_1_Line_1
	copyBatch1 = tempString.split("|");
	tempString  = dynamicContent.Google_AdWords_Tangram_Feed__Canada_feed[0].text_2; // Text_1_Line_1
	copyBatch2 = tempString.split("|");
	tempString  = dynamicContent.Google_AdWords_Tangram_Feed__Canada_feed[0].text_3; // Text_1_Line_1
...
function parseFontSizes()
{
	...
	if (dynamicContent.Google_AdWords_Tangram_Feed__Canada_feed[0].fontsize && dynamicContent.Google_AdWords_Tangram_Feed__Canada_feed[0].fontsize != "")
	{
		tempString = dynamicContent.Google_AdWords_Tangram_Feed__Canada_feed[0].fontsize;
...
{
	Enabler.exitOverride("CTA Exit", dynamicContent.Google_AdWords_Tangram_Feed__Canada_feed[0].Exit_URL.Url + dynamicContent.Google_AdWords_Tangram_Feed__Canada_feed[0].Sub_ID);
}

...
function drawTarget(ctx)
{
	...
	var fGradient = ctx.createLinearGradient(0,230,0,150);
	...
	var ang = -Math.atan2((img_target.sx-mousePos.x)/2.2,img_target.sy-mousePos.y)-90*Math.PI/180;
	...
	fGradient = ctx.createLinearGradient(0,230,0,150);
	fGradient.addColorStop(0, "rgba(100, 255, 175, 0.6)");			
	fGradient.addColorStop(1, "rgba(100, 255, 175, 0)");		
	ctx.fillStyle = fGradient;
